...
const SkillCard = ({ cardData }: { cardData: SkillCard }) => {
  return (
    <div className="flex flex-col p-10 rounded-2xl gap-10 items-center justify-center w-full bg-transparent text-gray-600">
...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="min-h-screen flex flex-col justify-center py-20 items-center gap-18 w-full relative overflow-hidden"
    >
      ...
      <div className="hidden md:block absolute top-3 z-10 left-1/2 -translate-x-1/2">
        <a
          href="#home"
          className="flex flex-col items-center gap-1 text-black hover:scale-110 hover:font-semibold transition-all duration-200"
        >
      ...
      {/* Carousel Container */}
      <div className="relative w-[90%] max-w-6xl flex items-center gap-2 justify-center">
        {/* Previous Button */}
        <button
          onClick={prevCard}
